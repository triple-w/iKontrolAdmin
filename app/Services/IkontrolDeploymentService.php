...
class IkontrolDeploymentService
{
    ...
    public function installOperationalCommandsFor(IkontrolInstance $instance): array
    {
        ...
        return ['action'=>'INSTALL_DIAGNOSTIC_TOOLS','before_status'=>'UNKNOWN','action_result'=>'FILES_WRITTEN','verification_result'=>'SPARK_DISCOVERY_OK','after_status'=>'READY','commands'=>$details,'runner'=>['cwd'=>$verification['cwd']??$path,'php_binary'=>$verification['php_binary']??null,'exit_code'=>$verification['exit_code']??null,'stdout_tail'=>$verification['stdout_tail']??null,'stderr_tail'=>$verification['stderr_tail']??null]];
    }
