...
// Variables
return [
  "creatorName" => "iKontrol",
  "creatorUrl" => "https://pixinvent.com",
  "templateName" => "iKontrol Admin",
  "templateSuffix" => "Panel central de administración",
  "templateVersion" => "3.0.0",
  "templateFree" => false,
  "templateDescription" => "Administración central de instalaciones iKontrol",
