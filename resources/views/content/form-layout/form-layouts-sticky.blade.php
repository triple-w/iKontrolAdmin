              ...
              <div class="row g-6">
                <div>
                  <div class="form-check form-check-inline">
                    ...
                    <label class="form-check-label d-flex gap-1" for="collapsible-payment-cc"> Credit/Debit/ATM Card <i
                        ...
                        <div class="mb-6">
                          ...
                          <div class="input-group input-group-merge">
                            ...
                            <span class="input-group-text cursor-pointer" id="collapsible-payment-cvv2"><i
                                class="icon-base ti tabler-help icon-xs" data-bs-toggle="tooltip"
