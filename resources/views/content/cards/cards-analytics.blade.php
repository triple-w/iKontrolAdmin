        ...
        <div class="card-body">
          ...
          <div class="border rounded p-5 mt-5">
            <div class="row gap-4 gap-sm-0">
              <div class="col-12 col-sm-4">
                <div class="d-flex gap-2 align-items-center">
                  <div class="badge rounded bg-label-primary p-1"><i
                      class="icon-base ti tabler-currency-dollar icon-sm"></i></div>
              ...
              <div class="col-12 col-sm-4">
                <div class="d-flex gap-2 align-items-center">
                  <div class="badge rounded bg-label-info p-1"><i class="icon-base ti tabler-chart-pie-2 icon-sm"></i>
                  </div>
              ...
              <div class="col-12 col-sm-4">
                <div class="d-flex gap-2 align-items-center">
                  <div class="badge rounded bg-label-danger p-1"><i class="icon-base ti tabler-brand-paypal icon-sm"></i>
                  </div>
          ...
          <ul class="nav nav-tabs widget-nav-tabs pb-8 gap-4 mx-1 d-flex flex-nowrap" role="tablist">
            ...
            <li class="nav-item">
              <a href="javascript:void(0);"
                ...
                aria-selected="false">
                <div class="badge bg-label-secondary rounded p-2"><i class="icon-base ti tabler-chart-bar icon-md"></i>
                </div>
      ...
      <div class="card h-100">
        ...
        <div class="card-body">
          ...
          <div class="vehicles-overview-progress progress rounded-3 mb-6" style="height: 46px;">
            <div class="progress-bar fw-medium text-start bg-lighter text-heading px-4 rounded-0" role="progressbar"
