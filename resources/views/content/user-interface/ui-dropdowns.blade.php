        ...
        <div class="col-lg-3 col-sm-6 col-12">
          ...
          <div class="demo-inline-spacing">
            <div class="btn-group" id="dropdown-icon-demo">
              <button type="button" class="btn btn-primary dropdown-toggle" data-bs-toggle="dropdown"
                aria-expanded="false"><i class="icon-base ti tabler-menu-2 icon-xs me-1"></i> With
                Icon</button>
              <ul class="dropdown-menu">
                <li>
                  <a href="javascript:void(0);" class="dropdown-item d-flex align-items-center"><i
                      class="icon-base ti tabler-chevron-right scaleX-n1-rtl"></i>Action</a>
                </li>
                <li>
                  <a href="javascript:void(0);" class="dropdown-item d-flex align-items-center"><i
                      class="icon-base ti tabler-chevron-right scaleX-n1-rtl"></i>Another action</a>
                </li>
                <li>
                  <a href="javascript:void(0);" class="dropdown-item d-flex align-items-center"><i
                      class="icon-base ti tabler-chevron-right scaleX-n1-rtl"></i>Something else
                    here</a>
                </li>
                <li>
                  <hr class="dropdown-divider" />
                ...
                <li>
                  <a href="javascript:void(0);" class="dropdown-item d-flex align-items-center"><i
                      class="icon-base ti tabler-chevron-right scaleX-n1-rtl"></i>Separated link</a>
                </li>
              </ul>
            </div>
          </div>
  ...
  <div class="card" id="dropdown-variation-demo">
      ...
      <div class="demo-inline-spacing">
        <div class="btn-group">
          <button type="button"
            ...
            data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">End-aligned dropdown
            menu</button>
          <ul class="dropdown-menu dropdown-menu-end">
    ...
    <div class="card-body">
      <div class="row gy-3">
        <!-- Dropdown options -->
        <div class="col-xl-6">
          <small class="fw-medium">Options : Use <code>data-bs-offset</code> or <code>data-bs-reference</code> to
            change the location of the dropdown.</small>
          <div class="demo-inline-spacing">
          ...
          <div class="demo-inline-spacing">
            ...
            <div class="btn-group">
              <button class="btn btn-primary dropdown-toggle" type="button" id="dropdownMenuClickable"
                data-bs-toggle="dropdown" data-bs-auto-close="false" aria-expanded="false">Manual
                close</button>
