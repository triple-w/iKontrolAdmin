            ...
            <div class="col-lg-4 col-md-6">
              ...
              <div class="mt-4">
                ...
                <button type="button" class="btn btn-primary" data-bs-toggle="modal"
                  data-bs-target="#modalTop">Launch modal</button>
        ...
        <div class="card-body">
          ...
          <div class="row gap-2 gap-sm-0 mt-4">
            ...
            <div class="col-12 col-sm-6 col-md-8">
              <button type="button" class="btn btn-primary" data-bs-toggle="modal"
                data-bs-target="#animationModal">Launch modal</button>
            </div>
          ...
          <div class="row gy-3">
            ...
            <div class="col-lg-4 col-md-6">
                    ...
                    <div id="modalCarouselControls" class="carousel slide pb-6 mb-2" data-bs-interval="false">
                      ...
                      <div class="carousel-inner">
                        <div class="carousel-item active">
                          ...
                          <div class="onboarding-content">
                            <h4 class="onboarding-title text-body">Example Request Information
                            </h4>
                            ...
                            <form>
                              <div class="row">
                                ...
                                <div class="col-sm-6">
                                  <div class="mb-4">
                                    <label for="roleEx" class="form-label">Your
                                      Role</label>
                        ...
                        <div class="carousel-item">
                          ...
                          <div class="onboarding-content">
                            ...
                            <div class="onboarding-info">In this example you can see a form
                            ...
                            <form>
                              <div class="row">
                                ...
                                <div class="col-sm-6">
                                  <div class="mb-4">
                                    <label for="roleEx1" class="form-label">Your
                                      Role</label>
                          ...
                          <div class="onboarding-content">
                            ...
                            <form>
                              <div class="row">
                                ...
                                <div class="col-sm-6">
                                  <div class="mb-4">
                                    <label for="roleEx2" class="form-label">Your
                                      Role</label>
                      ...
                      <a class="carousel-control-prev" href="#modalCarouselControls" role="button"
                        data-bs-slide="prev"> <i
                          class="icon-base ti tabler-chevrons-left me-2"></i><span>Previous</span>
                      </a>
                      <a class="carousel-control-next" href="#modalCarouselControls" role="button"
                        data-bs-slide="next"> <span>Next</span><i class="icon-base ti tabler-chevrons-right ms-2"></i>
                      </a>
                    </div>
                  </div>
                </div>
                    ...
                    <div class="modal-body p-0">
                      ...
                      <div class="onboarding-content mb-0">
                        ...
                        <div class="onboarding-info">In this example you can see a form where you
                          can request some additional information from the customer when they land
                          on the app page.</div>
                        <form>
                          <div class="row">
                            <div class="col-sm-6">
                              <div class="mb-4">
                                <label for="nameEx3" class="form-label">Your Full
                                  Name</label>
                                <input class="form-control" placeholder="Enter your full name..." type="text"
              ...
              <div class="demo-inline-spacing">
                <!-- slider modal -->
                <button type="button" class="btn btn-primary" data-bs-toggle="modal"
                  data-bs-target="#onboardingSlideModal">Multistep Slider modal</button>
                <!--/ slider modal -->

                <!-- Form with Image Modal -->
                <button type="button" class="btn btn-primary" data-bs-toggle="modal"
                  data-bs-target="#onboardImageModal">Modal with form</button>
                <!--/ Form with Image Modal -->
              </div>
            </div>
            ...
            <div class="col-lg-4 col-md-6">
                            ...
                            <div class="onboarding-content">
                              ...
                              <form>
                                <div class="row">
                                  <div class="col-sm-6">
                                    <div class="mb-4">
                                      <label for="nameEx4" class="form-label">Your
                                        Full Name</label>
                                      <input class="form-control" placeholder="Enter your full name..." type="text"
                            ...
                            <div class="onboarding-content">
                              ...
                              <form>
                                <div class="row">
                                  <div class="col-sm-6">
                                    <div class="mb-4">
                                      <label for="nameEx5" class="form-label">Your
                                        Full Name</label>
                                      <input class="form-control" placeholder="Enter your full name..." type="text"
                            ...
                            <div class="onboarding-content">
                              ...
                              <form>
                                <div class="row">
                                  <div class="col-sm-6">
                                    <div class="mb-4">
                                      <label for="nameEx6" class="form-label">Your
                                        Full Name</label>
                                      <input class="form-control" placeholder="Enter your full name..." type="text"
                      ...
                      <div class="onboarding-content mb-0">
                        ...
                        <form>
                          <div class="row">
                            <div class="col-sm-6">
                              <div class="mb-4">
                                <label for="nameEx7" class="form-label">Your Full
                                  Name</label>
                                <input class="form-control" placeholder="Enter your full name..." type="text"
              ...
              <div class="demo-inline-spacing">
                ...
                <button type="button" class="btn btn-primary" data-bs-toggle="modal"
                  data-bs-target="#onboardHorizontalImageModal">Modal with form</button>
              </div>
            </div>
                    ...
                    <div class="modal-content">
                      <div class="modal-body">
                        <a href="javascript:void(0);" class="btn-close text-white" data-bs-dismiss="modal"
                          aria-label="Close"></a>
                        <p class="text-white text-large fw-light mb-4">Subscribe to get latest
                          updates</p>
