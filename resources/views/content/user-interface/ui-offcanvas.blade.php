            ...
            <div class="col-lg-3 col-md-6">
              ...
              <div class="mt-4">
                <button class="btn btn-primary" type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvasStart"
                  aria-controls="offcanvasStart">Toggle Start</button>
                <div class="offcanvas offcanvas-start" tabindex="-1" id="offcanvasStart"
                  ...
                  <div class="offcanvas-body my-auto mx-0 flex-grow-0">
                    <p class="text-center">Lorem ipsum, or lipsum as it is sometimes known, is dummy
            ...
            <div class="col-lg-3 col-md-6">
              ...
              <div class="mt-4">
                <button class="btn btn-primary" type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvasEnd"
                  aria-controls="offcanvasEnd">Toggle End</button>
            ...
            <div class="col-lg-3 col-md-6">
              ...
              <div class="mt-4">
                <button class="btn btn-primary" type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvasTop"
                  aria-controls="offcanvasTop">Toggle Top</button>
        ...
        <div class="card-body">
          <div class="row gy-3">
            ...
            <div class="col-lg-4 col-md-6">
              ...
              <div class="mt-4">
                <button class="btn btn-primary" type="button" data-bs-toggle="offcanvas"
                  data-bs-target="#offcanvasBackdrop" aria-controls="offcanvasBackdrop">Enable
                  backdrop</button>
            ...
            <div class="col-lg-4 col-md-6">
              ...
              <div class="mt-4">
                ...
                <div class="offcanvas offcanvas-end" data-bs-scroll="true" tabindex="-1" id="offcanvasBoth"
                  ...
                  <div class="offcanvas-header">
                    <h5 id="offcanvasBothLabel" class="offcanvas-title">Enable both scrolling &
                      backdrop</h5>
                    <button type="button" class="btn-close text-reset" data-bs-dismiss="offcanvas"
                      aria-label="Close"></button>
                  </div>
        ...
        <div class="card-body">
          ...
          <div>
            <button class="btn btn-primary d-xl-none" type="button" data-bs-toggle="offcanvas"
              ...
              offcanvas-xl</button>
            <div class="alert alert-info d-xl-block d-none mt-4">Resize your browser to <code>xl</code>
              breakpoint to show the responsive offcanvas toggle.</div>
        ...
        <div class="card-body">
          ...
          <div>
            <button class="btn btn-primary" type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvasDark"
              aria-controls="offcanvasDark">Toggle Dark offcanvas</button>
