  ...
  <div class="row mb-6">
    ...
    <div class="col-md">
      <div class="card">
        ...
        <div class="card-body">
          <div class="alert alert-outline-primary" role="alert">This is a primary outline alert — check it out!
          </div>

          <div class="alert alert-outline-secondary" role="alert">This is a secondary outline alert — check it
            out!</div>

          <div class="alert alert-outline-success" role="alert">This is a success outline alert — check it out!
          </div>

          <div class="alert alert-outline-danger" role="alert">This is a danger outline alert — check it out!
          </div>

          <div class="alert alert-outline-warning" role="alert">This is a warning outline alert — check it out!
          </div>

          <div class="alert alert-outline-info" role="alert">This is an info outline alert — check it out!</div>

          <div class="alert alert-outline-dark mb-0" role="alert">This is a dark outline alert — check it out!
          </div>
        </div>
      </div>
    </div>
