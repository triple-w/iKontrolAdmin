  ...
  <div class="row g-6">
    <div class="col-12">
      <div class="card">
        ...
        <div class="card-body">
          <p class="card-text">Toggle the visibility of content across your project with a few classes and our
          ...
          <div class="collapse" id="collapseExample">
            <div class="d-grid d-sm-flex p-4 border">
              ...
              <span>
                ...
                Ipsum.It is a long established fact that a reader will be distracted by the readable content
        ...
        <div class="card-body">
          ...
          <div style="min-height: 120px;">
            <div class="collapse-horizontal collapse show" id="collapseWidthExample">
              <div class="p-4 border" style="width: 300px;">Lorem Ipsum is simply dummy text of the printing
                and typesetting industry Ipsum has been the.</div>
            </div>
          </div>
        </div>
      </div>
              ...
              <div class="collapse multi-collapse" id="multiCollapseExample1">
                <div class="d-grid d-sm-flex p-4 border">
                  <img src="{{ asset('assets/img/elements/2.png') }}" alt="collapse-image" height="125"
                    class="me-6 mb-sm-0 mb-2" />
                  <span> All the Lorem Ipsum generators on the Internet tend to repeat predefined chunks
                    ...
                    structures, to generate Lorem Ipsum which looks reasonable. </span>
                </div>
              </div>
            </div>
