            ...
            <td>
              <div class="dropdown">
                ...
                <div class="dropdown-menu">
                  <a class="dropdown-item" href="javascript:void(0);"><i class="icon-base ti tabler-pencil me-1"></i>
                    Edit</a>
          ...
          <tr>
            ...
            <td>
              <div class="dropdown">
                ...
                <div class="dropdown-menu">
                  <a class="dropdown-item" href="javascript:void(0);"><i class="icon-base ti tabler-pencil me-2"></i>
                    Edit</a>
                  <a class="dropdown-item" href="javascript:void(0);"><i class="icon-base ti tabler-trash me-2"></i>
                    Delete</a>
                </div>
              </div>
            </td>
      ...
      <table class="table">
        ...
        <tbody class="table-border-bottom-0">
          ...
          <tr class="table-warning">
            <td><i class="icon-base ti tabler-brand-react-native icon-md text-info me-4"></i> <span
                class="fw-medium">React Custom</span></td>
            <td>Ted Richer</td>
            <td>
              <ul class="list-unstyled m-0 avatar-group d-flex align-items-center">
                <li data-bs-toggle="tooltip" data-popup="tooltip-custom" data-bs-placement="top"
          ...
          <tr class="table-light">
            <td><i class="icon-base ti tabler-brand-angular icon-md text-danger me-4"></i> <span
  ...
  <div class="table-responsive text-nowrap">
    <table class="table">
      ...
      <tbody class="table-border-bottom-0">
        ...
        <tr>
          <td><i class="icon-base ti tabler-brand-vue icon-md text-success me-4"></i> <span class="fw-medium">VueJs
              Project</span></td>
          <td>Trevor Baker</td>
          <td>
            <ul class="list-unstyled m-0 avatar-group d-flex align-items-center">
            ...
            <td colspan="5">
              <table class="table mb-0 table-light">
                ...
                <tbody>
                  ...
                  <tr>
                    <td><i class="icon-base ti tabler-brand-vue icon-md text-success me-4"></i> <span
