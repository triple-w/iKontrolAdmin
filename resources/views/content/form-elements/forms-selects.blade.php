            ...
            <div class="col-md-6">
              ...
              <select id="select2Icons" class="select2-icons form-select">
                <optgroup label="Services">
                  <option value="Bootstrap5" data-icon="icon-base ti tabler-brand-bootstrap" selected>Bootstrap 5
                  </option>
          ...
          <div class="row g-6">
            ...
            <div class="col-md-6">
              ...
              <button type="button" class="btn btn-sm rounded-pill btn-icon btn-outline-primary mb-1"><span
                  class="icon-base ti tabler-plus"></span></button>
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="card-body">
          <div class="row g-6">
            ...
            <div class="col-md-6">
              ...
              <select class="selectpicker w-100 show-tick" id="selectpickerIcons" data-icon-base="icon-base ti"
                data-tick-icon="tabler-check" data-style="btn-default">
