...
<div class="card mb-6"><div class="card-body">
  ...
  @if($instance->installation_status->value === 'READY_FOR_DOMAIN')<div class="alert alert-info mt-5">Cree manualmente el subdominio en cPanel, apúntelo a:<br><code>{{ $instance->absolute_path }}/public</code><br>y después use “Confirmar dominio”.</div>@endif
</div></div>
